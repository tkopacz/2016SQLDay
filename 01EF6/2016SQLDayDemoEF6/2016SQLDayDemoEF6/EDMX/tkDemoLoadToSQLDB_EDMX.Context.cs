...
namespace _2016SQLDayDemoEF6.EDMX
{
    ...
    public partial class tkDemoLoadToSQLDBEntities : DbContext
    {
        public tkDemoLoadToSQLDBEntities()
            : base("name=tkDemoLoadToSQLDBEntities")
        {
        }
        ...
        [DbFunction("tkDemoLoadToSQLDBEntities", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[tkDemoLoadToSQLDBEntities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
    
        [DbFunction("tkDemoLoadToSQLDBEntities", "accessPredicate")]
        public virtual IQueryable<accessPredicate_Result> accessPredicate(Nullable<int> wing, Nullable<System.DateTime> startTime, Nullable<System.DateTime> endTime)
        {
            var wingParameter = wing.HasValue ?
                new ObjectParameter("wing", wing) :
                new ObjectParameter("wing", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<accessPredicate_Result>("[tkDemoLoadToSQLDBEntities].[accessPredicate](@wing, @startTime, @endTime)", wingParameter, startTimeParameter, endTimeParameter);
        }
    
        public virtual int psp1(Nullable<int> param1)
        {
            var param1Parameter = param1.HasValue ?
                new ObjectParameter("param1", param1) :
                new ObjectParameter("param1", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("psp1", param1Parameter);
        }
    
        public virtual int psp2(Nullable<int> param2)
        {
            var param2Parameter = param2.HasValue ?
                new ObjectParameter("param2", param2) :
                new ObjectParameter("param2", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("psp2", param2Parameter);
        }
    
        public virtual int spEgressOverwriteMarketingCampaignEffectiveness()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spEgressOverwriteMarketingCampaignEffectiveness");
        }
        ...
        public virtual ObjectResult<spGetArticleForOrder_Result> spGetArticleForOrder(string orderNo)
        {
            var orderNoParameter = orderNo != null ?
                new ObjectParameter("orderNo", orderNo) :
                new ObjectParameter("orderNo", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetArticleForOrder_Result>("spGetArticleForOrder", orderNoParameter);
        }
    }
}
