namespace _2016SQLDayDemoEF6.Model
{
    ...
    public partial class tkDemoLoadToSQLDB : DbContext
    {
        public tkDemoLoadToSQLDB()
        ...
        public virtual DbSet<abc2noncluster> abc2noncluster { get; set; }
        public virtual DbSet<abc3insert> abc3insert { get; set; }
        public virtual DbSet<AWBuildVersion> AWBuildVersions { get; set; }
        public virtual DbSet<DatabaseLog> DatabaseLogs { get; set; }
        public virtual DbSet<DemoDocTable> DemoDocTables { get; set; }
        public virtual DbSet<employee> employees { get; set; }
        public virtual DbSet<ErrorLog> ErrorLogs { get; set; }
        public virtual DbSet<MarketingCampaignEffectiveness> MarketingCampaignEffectivenesses { get; set; }
        public virtual DbSet<patient> patients { get; set; }
        public virtual DbSet<psptest1> psptest1 { get; set; }
        public virtual DbSet<sample_table> sample_table { get; set; }
        ...
        public virtual DbSet<abc1> abc1 { get; set; }
        ...
        public virtual DbSet<SalesOrderDetail1> SalesOrderDetail1 { get; set; }
        ...
        public virtual DbSet<tkViewAll> tkViewAlls { get; set; }

        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            modelBuilder.Entity<MarketingCampaignEffectiveness>()
                .Property(e => e.ProfileID)
                .IsUnicode(false);

            modelBuilder.Entity<MarketingCampaignEffectiveness>()
                .Property(e => e.SessionStart)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<MarketingCampaignEffectiveness>()
                .Property(e => e.Multiplayer)
                .IsUnicode(false);

            modelBuilder.Entity<MarketingCampaignEffectiveness>()
                .Property(e => e.EndRank)
                .IsUnicode(false);

            modelBuilder.Entity<MarketingCampaignEffectiveness>()
                .Property(e => e.WeaponsUsed)
                .IsUnicode(false);

            modelBuilder.Entity<MarketingCampaignEffectiveness>()
                .Property(e => e.UsersInteractedWith)
                .IsUnicode(false);

            modelBuilder.Entity<psptest1>()
                .Property(e => e.col3)
                .IsFixedLength();

            modelBuilder.Entity<sample_table>()
                .Property(e => e.c2)
                .IsFixedLength()
                .IsUnicode(false);
            ...
            modelBuilder.Entity<SalesOrderDetail1>()
                .Property(e => e.UnitPrice)
                .HasPrecision(19, 4);
